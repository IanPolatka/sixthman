...
$request = wp_safe_remote_get( 'https://6thmansports.com/api/boys-basketball/game/' . $id );
...
if ( is_home() ) {
	...
	wp_enqueue_script( 'boys-basketball', get_template_directory_uri() . '/box-scores/score-boys-basketball.js', array(), '20151215', true );
