...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/baseball/record/'  . $school_year . '/' . $team_name);
...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/baseball/schedule/' . $school_year . '/' . $team_name . '/1');
if( is_wp_error( $request ) ) {
	return false; // Bail early
}
					...
					echo '<td>';
						echo '<div class="the-game-details">';
							...
							echo '<div>';
								...
								if (($item->away_team_baseball_district) === ($item->home_team_baseball_district)) :
...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/baseball/record/' . $school_year . '/' . $team_name . '/2');
if( is_wp_error( $request ) ) {
	return false; // Bail early
}
...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/baseball/schedule/' . $school_year . '/' . $team_name . '/3');
if( is_wp_error( $request ) ) {
	return false; // Bail early
}
