...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/football/record/' . $school_year . '/' . $team_name);
					...
					echo '<td>';
						echo '<div class="the-game-details">';
							...
							echo '<div>';
								...
								if ((($item->away_team_football_class) === ($item->home_team_football_class)) &&
								(($item->away_team_football_district) === ($item->home_team_football_district))) :
