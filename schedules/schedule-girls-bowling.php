...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/girls-bowling/schedule/' . $school_year . '/' . $team_name . '/1');
...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/girls-bowling/schedule/' . $school_year . '/' . $team_name . '/2');
if( is_wp_error( $request ) ) {
	return false; // Bail early
}
...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/girls-bowling/schedule/' . $school_year . '/' . $team_name . '/3');
if( is_wp_error( $request ) ) {
	return false; // Bail early
}
