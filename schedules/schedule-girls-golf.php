...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/golf-girls/schedule/' . $school_year . '/' . $team_name . '/1');
...
$request 		= wp_safe_remote_get( 'https://6thmansports.com/api/golf-girls/schedule/' . $school_year . '/' . $team_name . '/2');
if( is_wp_error( $request ) ) {
	return false; // Bail early
}
